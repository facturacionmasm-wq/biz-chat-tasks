...
import {
  ...
  Building2, Bell, Search, Sparkles, MessageCircle, Phone, CalendarPlus, Shield, GraduationCap
} from 'lucide-react';
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden">
        ...
        {!collapsed && (
          <div className="px-3 py-3">
            <div className="flex items-center gap-2 bg-sidebar-custom-hover rounded-md px-3 py-1.5 text-sidebar-custom-muted text-sm cursor-pointer hover:bg-sidebar-custom-hover/80">
              <Search size={14} />
              <span>Buscar...</span>
              <kbd className="ml-auto text-[10px] bg-sidebar-custom-bg px-1.5 py-0.5 rounded border border-sidebar-custom-border">⌘K</kbd>
            </div>
          </div>
        )}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top bar */}
        <header className="h-12 shrink-0 bg-card border-b border-border flex items-center justify-between px-4">
